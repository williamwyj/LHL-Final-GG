...
export default function UserProfile(props) {
  ...
  useEffect(()=>{
    followerNames.includes(username) ? setFollowButton("UnFollowButton") : setFollowButton("FollowButton")
  ...
  return (
    <section className="container userprofile">
      <div className="profileimgname"> 
        ...
        {props.username}
        {token && !(props.username === username) && followButton === "FollowButton" && <FollowButton follow={onFollowSubmit}/>}
        {token && !(props.username === username) && followButton === "UnFollowButton" && <UnFollowButton unfollow={onUnFollowSubmit}/>}
      </div>
